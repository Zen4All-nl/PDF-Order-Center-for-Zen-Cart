...
define('PDFOC_COMMENTS', 'Commentaar:'); //dutch
...
define('PDFOC_COMMENTS_AUTO_SHIPPED_TEXT', 'Bedankt voor uw bestelling. Uw bestelling is verzonden.'); // dutch
define('PDFOC_COMMENTS_AUTO_CC_DECLINED', 'Voeg de standaard "bestelling wordt verzonden" tekst toe'); // dutch
define('PDFOC_COMMENTS_AUTO_CC_DECLINED_TEXT', 'Bedankt voor uw bestelling. Uw bestelling wordt binnen enkele werkdagen verzonden.'); // dutch
define('PDFOC_COMMENTS_AUTO_BACKORDER', 'Insert standard backorder comment');
define('PDFOC_COMMENTS_AUTO_BACKORDER_TEXT', 'Uw bestelling staat in backorder. We verwachten ... te kunnen verzenden.');
...
define('PDFOC_LEGEND_INVOICE','Factuur'); // dutch
...
define('PDFOC_TEXT_DATE_CREDIT_CREATED','Creditfactuurdatum:'); // dutch
define('PDFOC_TEXT_DATE_INVOICE_CREATED','Factuurdatum:'); // dutch
define('PDFOC_TEXT_DATE_ORDER_LAST_MODIFIED','Last Modified:');
define('PDFOC_TEXT_INFO_IP_ADDRESS','IP-adres:'); // dutch
define('PDFOC_TEXT_INFO_PAYMENT_METHOD','Betaalmethode:'); // dutch
define('PDFOC_TEXT_INFO_SHIPPING_METHOD','Verzendmethode:'); // dutch
define('PDFOC_TEXT_NO', 'NO');
define('PDFOC_TEXT_PRODUCTS_ORDERED', 'Bestelde producten: '); // dutch
...
define('PDFOC_ENTRY_CREDIT', 'CREDITFACTUUR'); // dutch
define('PDFOC_ENTRY_EMAIL', 'E-mail:');
define('PDFOC_ENTRY_INVOICE', 'FACTUUR'); //dutch
define('PDFOC_ENTRY_PACKING_SLIP', 'PAKBON'); //dutch
define('PDFOC_ENTRY_PHONE', 'Tel.:'); // dutch
define('PDFOC_ENTRY_QUOTE', 'PRIJSOPGAVE'); // dutch
define('PDFOC_ENTRY_QUOTE_FOR', 'Prijsopgave voor:');
define('PDFOC_ENTRY_PAYMENT_METHOD', 'Betaalmethode:'); //dutch
define('PDFOC_ENTRY_PAYMENT_TYPE', 'Credit Card:');
define('PDFOC_ENTRY_SHIPPING', 'Shipping:'); // 
define('PDFOC_ENTRY_SHIP_TO', 'Afleveradres:'); // dutch
define('PDFOC_ENTRY_SOLD_TO', 'Verkocht aan:'); // dutch
define('PDFOC_ENTRY_SUBTOTAL', 'Subtotaal:'); // dutch
define('PDFOC_ENTRY_TAX', 'BTW:'); // dutch
define('PDFOC_ENTRY_TOTAL', 'Totaal:'); // dutch
define('PDFOC_PAYMENT_TYPE', 'Credit Card');
define('PDFOC_SHIP_FROM_COUNTRY', 'Nederland');  // used to prevent printing of country for national deliveries
define('PDFOC_TABLE_HEADING_COMMENTS', 'Commentaar');
define('PDFOC_TABLE_HEADING_PRICE_EXCLUDING_TAX', 'Prijs (excl.)'); // dutch
define('PDFOC_TABLE_HEADING_PRICE_INCLUDING_TAX', 'Prijs (incl.)'); // dutch
define('PDFOC_TABLE_HEADING_PRODUCTS_MODEL', 'Model'); 
define('PDFOC_TABLE_HEADING_PRODUCTS', 'Product'); // dutch
define('PDFOC_TABLE_HEADING_TAX', 'BTW'); // dutch
define('PDFOC_TABLE_HEADING_TOTAL', 'Totaal'); // dutch
define('PDFOC_TABLE_HEADING_TOTAL_EXCLUDING_TAX', 'Totaal (excl.)'); // dutch
define('PDFOC_TABLE_HEADING_TOTAL_INCLUDING_TAX', 'Totaal (incl.)'); // dutch
define('PDFOC_TEXT_COMMENTS','Commentaar:'); // dutch
define('PDFOC_TEXT_INVOICE_DATE','Factuurdatum:'); // dutch
define('PDFOC_TEXT_INVOICE_NUMBER','Factuurnummer:'); // dutch
define('PDFOC_TEXT_ORDER_DATE','Besteldatum:'); // dutch
define('PDFOC_TEXT_ORDER_FORMAT','F j, Y');
define('PDFOC_TEXT_ORDER_NUMBER','Bestelnummer:'); // dutch

// Settings for the order update e-mail to the customer
//
define('PDFOC_EMAIL_SALUTATION', 'Geachte %s,'); // dutch
define('PDFOC_EMAIL_SEPARATOR', '-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-');
define('PDFOC_EMAIL_TEXT_COMMENTS_UPDATE', 'Opmerkingen over uw bestelling:' . "\n\n%s\n\n"); // dutch
define('PDFOC_EMAIL_TEXT_DATE_ORDERED', 'Datum besteld:'); // dutch
define('PDFOC_EMAIL_TEXT_INVOICE_URL', 'Details bestelling:'); // dutch
define('PDFOC_EMAIL_TEXT_ORDER_NUMBER', 'Bestelnummer:'); // dutch

// Be sure to replace the e-mail address in the following line with the correct one for your store:
define('PDFOC_EMAIL_IF_QUESTIONS', "Als u vragen heeft kunt u deze stellen door te reageren op dit bericht.\n\n"); // dutch
define('PDFOC_EMAIL_SIGNOFF', "Met vriendelijke groet,\n\n"); // dutch
...
// include it here.
$pdfoc_subject[1] = 'Uw bestelling (bestelnummer #%d) is ontvangen'; // In behandeling genomen
$pdfoc_subject[2] = 'Uw bestelling (bestelnummer #%d) wordt verwerkt'; // Wordt verwerkt
$pdfoc_subject[3] = 'Uw bestelling (bestelnummer #%d) is verzonden'; // Verzonden
$pdfoc_subject[4] = 'Een update voor bestelling #%d'; // Update
$pdfoc_subject[5] = 'Uw bestelling (bestelnummer #%d) is geannuleerd'; // Geannuleerd
?>
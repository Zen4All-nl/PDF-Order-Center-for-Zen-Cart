...
if ($pageloop == "0") {   // initialize pdf settings
  ...
  //
  $pdf->ezSetY($y - 45);
  $cx = (PDFOC_SOLD_TO_COLUMN_START-10-$pdf->getTextWidth(PDFOC_GIANT_FONT_SIZE,PDFOC_ENTRY_QUOTE))*0.5;
  $pdf->ezText(PDFOC_ENTRY_QUOTE,PDFOC_GIANT_FONT_SIZE, array('aleft'=>$cx));

  //left rounded rectangle around "quote for" info
  //
  $pdf->ezSetY($y);
  $pdf->setStrokeColor(0,0,0);
  $pdf->setLineStyle(1);
  ...
  // "quote for" info in left rectangle
  $pdf->addText(PDFOC_SOLD_TO_COLUMN_START,$y,PDFOC_SUB_HEADING_FONT_SIZE,"<b>" . PDFOC_ENTRY_QUOTE_FOR . "</b>");

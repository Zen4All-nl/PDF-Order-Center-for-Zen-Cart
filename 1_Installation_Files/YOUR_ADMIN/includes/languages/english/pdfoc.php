...
define('PDFOC_COMMENTS_HELPTEXT', 'Optionally specify comments to store in the database with the new status. You can specify a default message to include by checking the appropriate box above. If printing an invoice, credit, packing slip, or quote and "print comments" is selected, this comment will also be printed.');
...
define('PDFOC_DELETE_ORDERS_HELPTEXT', 'Delete the orders in the orders list. If Restock is selected, product quantities will be restocked.<br /><br /> You will be asked to confirm before the orders are deleted.');
define('PDFOC_DELIVERY', 'Delivery:');
define('PDFOC_ENTER_CUSTOMER_DATA', 'Search terms:');
define('PDFOC_ENTER_CUSTOMER_DATA_HELPTEXT', 'Enter customer data to search for (part of the customer, shipping, or billing name or address, telephone number, or ip address).');
define('PDFOC_ENTER_DATES', 'Dates:');
define('PDFOC_ENTER_DATES_HELPTEXT', 'Click to select start and end order creation dates from the calendar, or manually enter the date range (in YYYY-MM-DD format).');
define('PDFOC_ENTER_NUMBERS', 'Order numbers:');
define('PDFOC_ENTER_NUMBERS_HELPTEXT', 'Enter order numbers and/or ranges in ascending order without white space. Example (don\'t enter the quotes):<br />"2577,2580-2585,2588"');
...
define('PDFOC_INVOICE_FINAL_OR_PREVIEW_HELPTEXT', 'A unique, sequential invoice number will be generated and stored in the database for a final invoice. No invoice number will be generated for an invoice preview. See the PDFOC manual for details.');
...
define('PDFOC_ORDERS_SELECT_HELPTEXT', "Please specify customer data search terms, order numbers, dates, and/or order status to select the desired orders.<br />Missing orders will simply be skipped. The selected orders will then be displayed in the orders list below.");
...
define('PDFOC_NOTIFY_COMMENTS_HELPTEXT', 'Include the comments specified here (if any) in the e-mail sent to the customer(s). Note: each customer will receive the same comments.');
define('PDFOC_SUBMIT_USE_SELECTED', 'Use');
define('PDFOC_SUBMIT_SELECTED_HELPTEXT', 'Click "Use" to select the checked orders in the list below. Click "Omit" to select the UNCHECKED orders.');
...
define('PDFOC_MESSAGE_SUCCESS', "A PDF of %d page(s) and %d record(s) was successful! <a href=\"%s\" target=\"_blank\" id=\"pdfocMessageLink\"><b>Click here</b></a> to open the file.");

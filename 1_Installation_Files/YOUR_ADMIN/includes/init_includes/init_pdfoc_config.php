...
$module_constant = 'PDFOC_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/pdfoc';
$module_name = "PDF Order Center";
$zencart_com_plugin_id = 35; // from zencart.com plugins - Leave Zero not to check
...
if (defined($module_constant)) {
  ...
  $db->Execute("INSERT INTO " . TABLE_CONFIGURATION_GROUP . " (configuration_group_title, configuration_group_description, sort_order, visible) VALUES ('" . $module_name . "', 'User-customizable defaults for " . $module_name . "', '1', '1');");
...
if (!function_exists('plugin_version_check_for_updates')) {
  ...
  function plugin_version_check_for_updates($plugin_file_id = 0, $version_string_to_check = '', $strict_zc_version_compare = false)
  {
